  ...
  return (
    <div className="w-full py-8 bg-white-300 backdrop-filter backdrop-blur-sm bg-opacity-30 text-blue-600">
      <div className="flex flex-col items-center justify-center">
        <h1 className="font-semibold text-2xl mb-6">Kumar Utsav</h1>
        <nav className="w-full max-w-2xl flex flex-wrap justify-center items-center gap-8 mb-4 text-lg">
          ...
          <a href="#experience" className="text-white text-opacity-80 hover:scale-125 duration-300">
            Experience
          </a>
        ...
        <p className="text-sm text-gray-400 my-5">&copy; 2023 Kumar Utsav. All rights reserved.</p>
      </div>
    </div>
  );
}
