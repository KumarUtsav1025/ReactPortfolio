        ...
        <div className='flex flex-col md:flex-row items-center justify-center px-5 md:px-0'>
          ...
          <div name='left' className='h-full w-full md:w-1/2 p-3 flex flex-col items-center'>
            ...
            <div name='socials' className='flex flex-row px-2 w-full justify-center'>
              <a href='https://github.com/KumarUtsav1025'>
                <FaGithub className='size-12 text-white mx-2 hover:scale-125 duration-300'/>
              </a>
              <a href='https://www.linkedin.com/in/kumar-utsav-flutdev/'>
                <FaLinkedin className='size-12 text-white mx-2 hover:scale-125 duration-300'/>
              </a>
              <a href='https://leetcode.com/KumarUtsav2510/'>
                <SiLeetcode className='size-12 text-white mx-2 hover:scale-125 duration-300'/>
              </a>
              <a href='https://www.instagram.com/utsav__mishra_/'>
                <FaInstagram className='size-12 text-white mx-2 hover:scale-125 duration-300'/>
              </a>
              <a href='https://www.facebook.com/utsav.k.mishra.9'>
                <FaFacebook className='size-12 text-white mx-2 hover:scale-125 duration-300'/>
              </a>
              <a href='https://twitter.com/KumarUt34789306'>
                <FaTwitter className='size-12 text-white mx-2 hover:scale-125 duration-300'/>
              </a>
            </div>
          </div>
        </div>
